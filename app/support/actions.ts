...
export async function getAIResponse(userMessage: string, messageHistory: { role: string, content: string }[]) {
  ...
  return `(Simulated Support AI) I understand you need help with "${userMessage}". Our platform allows you to find mentors by searching for skills on the Search page. If you're encountering a technical issue, please let me know more details!`;
}
