  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-16">
      ...
      <div className="border-b border-slate-200 pb-8 mt-4">
        ...
        <p className="text-slate-500 mt-2 text-lg">Manage your public information and community settings.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-2">Community Balance</h3>
            <div className="flex items-end gap-2 mb-4">
              <span className="text-5xl font-black">{profile.mentorshipsOwed}</span>
              <span className="text-slate-400 font-medium mb-1">Owed</span>
            </div>
