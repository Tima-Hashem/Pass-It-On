...
export default function ActiveMentorshipCard({ id, isMentor, counterpartName, skillName }: MentorshipCardProps) {
  ...
  return (
    <div className="group relative bg-white p-6 rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
      ...
      <div className="relative z-10 flex items-center gap-4 mb-4 flex-1">
      ...
      <Link 
        ...
        className="w-full mt-auto block text-center bg-slate-50 hover:bg-slate-100 text-slate-600 font-semibold py-2.5 rounded-xl transition-colors border border-slate-200"
      >
